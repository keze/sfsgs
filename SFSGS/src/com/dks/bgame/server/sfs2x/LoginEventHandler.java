...
public class LoginEventHandler extends BaseServerEventHandler {
	...
	public void handleServerEvent(ISFSEvent event) throws SFSException {
		...
		try {
	        ...
	        PreparedStatement stmt = connection.prepareStatement("SELECT Email,Password FROM User WHERE Email=?");
	     ...
	     // Execute query
	    			...
	    			//if (password != dbPword)
	    			{
	    				...
	    				throw new SFSLoginException("Login failed for user: "  + userName + password + dbPword, data);
	    			}
